...
const getAllClimbers = async (req, res) => {
    ...
    try {
        ...
        if (allClimbersData.length === 0) {
            ...
            .map(selectDataFields("_id", "about", "nickname", "home_crag", "image", "gear", "climbing_style", "strengths", "current_location", "experience_y", "onsight_level", "redpoint_level", "travelling", "weight"));
